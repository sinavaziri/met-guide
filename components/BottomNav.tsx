  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        {/* Viewfinder corners */}
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={active ? 2.25 : 1.5}
          d="M7 3H5a2 2 0 00-2 2v2m0 10v2a2 2 0 002 2h2m10-16h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2"
        />
        {/* Center circle */}
        <circle cx="12" cy="12" r="3" strokeWidth={active ? 2.25 : 1.5} fill={active ? 'currentColor' : 'none'} />
      </svg>
    ),
  },
  {
